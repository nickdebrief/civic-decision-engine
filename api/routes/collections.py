...
def _render_collection_members(memberships: list[dict]) -> str:
    rows = "".join(
        f"""<tr>
          ...
          <td class="public-collection-member-type">{escape(_display(item.get('member_type_label')))}</td>
