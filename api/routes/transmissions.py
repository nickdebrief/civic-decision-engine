...
def _render_attachments(attachments: list[dict]) -> str:
    ...
    return f"""<section><h2>Included Governed Objects</h2><p class="transmission-boundary">Each referenced object keeps its own identity, lifecycle, provenance, verification, and public page. The Transmission preserves communication context only.</p><div class="transmission-results"><table class="transmission-table"><thead><tr><th>Position</th><th>Inclusion reference</th><th>Object type</th><th>Object</th><th>Object reference</th><th>Relationship</th><th>Public note</th></tr></thead><tbody>{rows}</tbody></table></div></section>"""
