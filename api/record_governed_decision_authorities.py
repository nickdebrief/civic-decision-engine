...
def create_mandate(conn: sqlite3.Connection, *, authority_id: int | str, mandate_basis_category: str, title_label: str, subject_matter_scope: str, procedural_scope: str, territorial_organisational_scope: str | None, affected_class: str | None, effective_from: str | None, effective_to: str | None, express_limitations: str, conditions_prerequisites: str, delegation_status: str = "not_delegated", delegating_authority_id: int | None = None, delegating_mandate_id: int | None = None, delegation_source_declaration: Mapping[str, Any] | None = None, rationale: str, qualification: str, limitations: str, qualification_contract: Mapping[str, Any], recorder_declaration: Mapping[str, Any], bindings: list[Mapping[str, Any]], actor: str, actor_role: str, idempotency_key: str | None = None, created_at: str | None = None, document_root: Path | None = None, _commit: bool = True) -> dict[str, Any]:
    ...
    if delegation_status not in DELEGATION_STATUSES: raise ValueError("governed_delegation_status_invalid")
    if delegation_status != "delegated" and (delegating_authority_id is not None or delegating_mandate_id is not None): raise ValueError("governed_delegation_parent_unexpected")
    normalized = _validate_sources(conn, bindings, document_root=document_root)
