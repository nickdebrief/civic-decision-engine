    ...
    for attachment in parser.iter_attachments():
        ...
        governed.append(
            govern_attachment_bytes(
                ...
                source_metadata={
                    "gmail_attachment_identifier": attachment.get("source_attachment_identifier"),
                    "gmail_mime_part_id": attachment.get("mime_part_index"),
                    "transfer_encoding": attachment.get("transfer_encoding"),
                    "embedded_message_status": attachment.get("is_attached_message"),
                },
                acquisition_source=GMAIL_TAKEOUT_SOURCE_FORMAT,
