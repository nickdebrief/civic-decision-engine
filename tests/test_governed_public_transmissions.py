...
class GovernedPublicTransmissionTests(unittest.TestCase):
    ...
    def test_public_library_search_and_detail_render(self):
        ...
        self.assertIn('class="transmission-results transmission-attachments-wrapper"', detail)
        self.assertIn('aria-label="Included Governed Objects table"', detail)
        self.assertIn('class="transmission-table transmission-attachments-table"', detail)
        self.assertIn('<col class="transmission-attachment-object-col">', detail)
        self.assertIn('<th scope="col">Position</th>', detail)
        self.assertIn('<th scope="col">Inclusion reference</th>', detail)
        self.assertIn('<th scope="col">Object type</th>', detail)
        self.assertIn('<th scope="col">Object</th>', detail)
        self.assertIn('<th scope="col">Object reference</th>', detail)
        self.assertIn('<th scope="col">Relationship</th>', detail)
        self.assertIn('<th scope="col">Public note</th>', detail)
        ...
        self.assertIn('<table class="metadata"><thead><tr><th>Timestamp</th>', detail)
