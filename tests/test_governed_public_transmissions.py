...
class GovernedPublicTransmissionTests(unittest.TestCase):
    ...
    def test_public_library_search_and_detail_render(self):
        ...
        self.assertIn('aria-label="Public Transmission Library table"', index)
        self.assertIn("transmission-table governance-table governance-table--dense", index)
        self.assertIn("transmission-reference table-cell--identifier", index)
        self.assertIn("transmission-title table-cell--content", index)
        self.assertIn("transmission-method table-cell--label", index)
        ...
        self.assertIn('class="transmission-results transmission-attachments-wrapper governance-table-wrap"', detail)
        self.assertIn('aria-label="Included Governed Objects table"', detail)
        self.assertIn('class="transmission-table transmission-attachments-table governance-table governance-table--dense"', detail)
        self.assertIn('<col class="transmission-attachment-object-col">', detail)
        self.assertIn('<th scope="col" class="table-cell--compact">Position</th>', detail)
        self.assertIn('<th scope="col" class="table-cell--identifier">Inclusion reference</th>', detail)
        self.assertIn('<th scope="col" class="table-cell--label">Object type</th>', detail)
        self.assertIn('<th scope="col" class="table-cell--content">Object</th>', detail)
        self.assertIn('<th scope="col" class="table-cell--identifier">Object reference</th>', detail)
        self.assertIn('<th scope="col" class="table-cell--label">Relationship</th>', detail)
        self.assertIn('<th scope="col" class="table-cell--note">Public note</th>', detail)
        self.assertIn("transmission-attachment-position{", detail)
        self.assertIn("transmission-attachment-reference,.transmission-attachment-object-reference", detail)
        self.assertIn("transmission-attachment-relationship{white-space:nowrap}", detail)
        self.assertIn("transmission-attachment-note{color:#555}", detail)
        self.assertIn('aria-label="Transmission Publication Provenance table"', detail)
        self.assertIn("transmission-provenance-table", detail)
        self.assertIn("word-break:normal", detail)
        ...
        self.assertIn("Workbook transmitted with the covering communication.", detail)
        self.assertIn("Canonical Complaint record referenced in the communication.", detail)
        self.assertIn("Transmission Publication Provenance", detail)
        self.assertIn('<table class="metadata governance-table governance-table--dense transmission-provenance-table">', detail)
