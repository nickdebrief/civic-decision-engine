...
class PlatformIdentityTransitionTests(unittest.TestCase):
    ...
    def test_admin_console_renders_identity_without_removing_navigation(self):
        ...
        self.assertIn(">v13.0</span>", response.content)
        self.assertNotIn("Platform version v13.0", response.content)
    ...
    def test_release_documentation_records_identity_transition(self):
        ...
        self.assertIn("docs/releases/CDE_PLATFORM_STAGE_LEDGER.md", readme)
        ...
        self.assertIn("docs/releases/CDE_PLATFORM_STAGE_39A_PST_OST_PARSER_INTAKE_BOUNDARY.md", readme)
