...
CREF Stage 37 adds a deterministic, read-only declaration of how the Civic Record
Evaluation Framework methodology is preserved and maintained. It follows the
CREF Stage 36 self-containment certification by making stewardship responsibilities
...
visible outputs from CREF Stages 21–36. It contains 25 stewardship declarations and
...
Full Inspection remains the default report mode. CREF Stage 37 follows CREF Stage 36 in
all three modes.

## Limitations

CREF Stage 37 is not legal ownership, accreditation, institutional authority, or an
...
CREF Stage 37 adds a deterministic builder and scoped admin renderers to
